...
final class StockLabelService
{
    ...
    /** @return array<string, array{label: string, layout: string, width_mm: float, height_mm: float, avery?: string, page_width_mm?: float, page_height_mm?: float, cols?: int, rows?: int, margin_mm?: float, gap_mm?: float}> */
