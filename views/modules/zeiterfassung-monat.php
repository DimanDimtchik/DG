            ...
            <?php foreach ($days as $day) : ?>
              ...
              <tr<?= $empty ? ' class="dg-muted"' : '' ?>>
                ...
                <td class="dg-table__num">
                  ...
                  <?php if (($day['schedule_source'] ?? '') === 'absence' && ($day['absence_label'] ?? '') !== '') : ?>
                    <br><span class="dg-muted"><?= View::escape((string) $day['absence_label']) ?></span>
                  <?php elseif (($day['schedule_source'] ?? '') === 'shift' && ($day['shift_name'] ?? '') !== '') : ?>
